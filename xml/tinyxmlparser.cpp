									...
									TiXmlEncoding encoding )
{
    *text = "";
	...
	else
	{
		...
		//Added by yiming for resolve all spaces
		int iSpaceCount = 0;
...
TiXmlNode* TiXmlNode::Identify( const char* p, TiXmlEncoding encoding )
{
	...
	const char* xslHeader = { "<?xml-stylesheet" };

	//Modified by yiming for fixing the bug tinyxml treats the xsl as declaration
	if ( StringEqual( p, xslHeader , true , encoding))
	{
		#ifdef DEBUG_PARSER
			TIXML_LOG( "XML parsing xsl schema\n" );
		#endif
